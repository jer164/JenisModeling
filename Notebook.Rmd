...
predict.glm(cone_model, data.frame(days_real = 'Saturday', dailyprecip = 0.0, dailytemp = 75, snow = 0, thunder = '0', gallery_hop = 'Yes', is_holiday = "Yes"))
...
print(round((predict(cone_model, data.frame(days_real = a, dailyprecip = b, dailytemp = c, snow = 0, thunder = '0', gallery_hop = d, is_holiday = e), interval = 'confidence'))))

print(round((predict(bowl_model, data.frame(days_real = a, dailyprecip = b, dailytemp = c, snow = 0, thunder = '0', gallery_hop = d, is_holiday = e), interval = 'confidence'))))
...
save(firstmodel, file = "data_for_waffle_model.Rdata")
